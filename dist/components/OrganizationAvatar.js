...
function OrganizationAvatar(props) {
    ...
    return (react_1.default.createElement(core_1.Tooltip, { title: name },
        react_1.default.createElement("span", null,
            react_1.default.createElement(core_1.Avatar, { variant: "rounded", src: src, className: (0, clsx_1.default)(classes.avatar, className, {
                ...
                : react_1.default.createElement(icons_1.Business, { fontSize: size })))));
}
