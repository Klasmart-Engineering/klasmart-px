...
function ConfirmDialog(props) {
    const { variant, open, title, content, hideIcon, cancelLabel, okLabel, onClose, ...rest } = props;
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(core_1.Dialog, { fullWidth: true, open: open, onClose: () => onClose(), ...rest },
            ...
            react_1.default.createElement(core_1.DialogActions, null,
                ...
                react_1.default.createElement(Button_1.default, { label: okLabel, color: "primary", onClick: () => onClose(true) })))));
}
