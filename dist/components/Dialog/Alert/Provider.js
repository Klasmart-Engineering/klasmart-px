...
function AlertDialogProvider(props) {
    ...
    const alert = (0, react_1.useCallback)((options) => {
        const dialogOptions = {
            ...DEFAULT_OPTIONS,
            ...userDefaultOptions,
            ...options,
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        react_1.default.createElement(Context_1.default.Provider, { value: alert }, children),
        react_1.default.createElement(Dialog_1.default, { open: resolves.length === 1, onClose: handleClose, ...options })));
}
exports.default = AlertDialogProvider;
